...
// ----------------------------------------------------------------------------
// DKM SAI migration: surface identity principalIds the upstream AVM module
// already exposes but the wrapper had previously hidden. Pure additive
// change — no existing output modified.
// ----------------------------------------------------------------------------
