...
Prompts focus on housing issues, document filtering, and comparing annual report outcomes. Key functionalities include:

### **Overview**
_Sample Worlflow:_

- Question: What are the main factors contributing to the current housing affordability issues?
- Task: Click one of the **suggested follow-up questions** and get a reasonable response.
